 	...
 	<div class="container">
	  ...
	  ?>
	    <tr>
	      ...
	      <td><?php echo $dato['COD_MATERIA']; ?></td>
	      <td><button class="btn btn-warning"><a href="edit.php?id_materia=<?php echo $dato['ID_MATERIA'] ?>" style="text-decoration: none;color: black;">Editar</a></button>
	      		<button class="btn btn-danger"><a href="delete.php?id_materia=<?php echo $dato['ID_MATERIA'] ?>" style="text-decoration: none;color: black;">Eliminar</a></button>
	      </td>
	    </tr>
		<?php $conta++; } ?>
	  </tbody>
 	</table>
 	<button class="btn btn-outline-secondary"><a href="add.php" style="text-decoration: none;color: black;">Agregar materia</a></button>
 </body>
 </html>